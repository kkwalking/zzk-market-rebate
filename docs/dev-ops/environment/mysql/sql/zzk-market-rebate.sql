/*
 ...
 Source Schema         : zzk-market-rebate

 Target Server Type    : MySQL
 Target Server Version : 80032
 File Encoding         : 65001

 Date: 23/09/2024 23:38:36
*/


SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `zzk-market-rebate` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `zzk-market-rebate`;
/*
 Navicat Premium Data Transfer
...
-- Records of strategy
-- ----------------------------
INSERT INTO `strategy` VALUES (1, 100001, '抽奖策略', 'rule_weight,rule_blacklist', '2023-12-09 09:37:19', '2023-12-09 18:06:34');
INSERT INTO `strategy` VALUES (2, 100003, '抽奖策略-验证lock', 'rule_weight,rule_blacklist', '2024-01-13 10:34:06', '2024-09-30 10:40:45');
INSERT INTO `strategy` VALUES (3, 100002, '抽奖策略-非完整1概率', NULL, '2023-12-09 09:37:19', '2024-01-13 11:08:20');
...
-- ----------------------------
INSERT INTO `strategy_award` VALUES (1, 100001, 101, '随机积分', NULL, 80000, 80000, 0.1000, 'rule_random', 1, '2023-12-09 09:38:31', '2024-09-30 10:48:01');
INSERT INTO `strategy_award` VALUES (2, 100001, 102, '5次使用', NULL, 10000, 10000, 0.1000, 'rule_luck_award', 2, '2023-12-09 09:39:18', '2024-09-30 10:48:48');
INSERT INTO `strategy_award` VALUES (3, 100001, 103, '10次使用', NULL, 5000, 5000, 0.1000, 'rule_luck_award', 3, '2023-12-09 09:42:36', '2024-09-30 10:48:46');
INSERT INTO `strategy_award` VALUES (4, 100001, 104, '20次使用', NULL, 4000, 4000, 0.1000, 'rule_luck_award', 4, '2023-12-09 09:43:15', '2023-12-23 14:00:10');
INSERT INTO `strategy_award` VALUES (5, 100001, 105, '增加gpt-4对话模型', NULL, 600, 600, 0.1500, 'rule_luck_award', 5, '2023-12-09 09:43:47', '2024-09-30 10:48:41');
INSERT INTO `strategy_award` VALUES (6, 100001, 106, '增加dall-e-2画图模型', NULL, 200, 200, 0.1500, 'rule_luck_award', 6, '2023-12-09 09:44:20', '2024-09-30 10:48:36');
INSERT INTO `strategy_award` VALUES (7, 100001, 107, '增加dall-e-3画图模型', '抽奖1次后解锁', 200, 200, 0.1500, 'rule_lock,rule_luck_award', 7, '2023-12-09 09:45:38', '2024-09-30 10:48:33');
INSERT INTO `strategy_award` VALUES (8, 100001, 108, '增加100次使用', '抽奖2次后解锁', 199, 199, 0.1500, 'rule_lock,rule_luck_award', 8, '2023-12-09 09:46:02', '2024-09-30 10:48:20');
...
INSERT INTO `strategy_award` VALUES (10, 100002, 101, '随机积分', NULL, 1, 1, 0.5000, 'rule_random,rule_luck_award', 1, '2023-12-09 09:46:39', '2023-12-23 14:23:51');
INSERT INTO `strategy_award` VALUES (11, 100002, 102, '5次使用', NULL, 1, 1, 0.1000, 'rule_random,rule_luck_award', 2, '2023-12-09 09:46:39', '2023-12-23 14:23:52');
INSERT INTO `strategy_award` VALUES (12, 100002, 106, '增加dall-e-2画图模型', NULL, 1, 1, 0.0100, 'rule_random,rule_luck_award', 3, '2023-12-09 09:46:39', '2023-12-23 14:23:53');
INSERT INTO `strategy_award` VALUES (13, 100003, 107, '增加dall-e-3画图模型', '抽奖1次后解锁', 200, 200, 0.0400, 'rule_lock,rule_luck_award', 7, '2023-12-09 09:45:38', '2023-12-23 14:01:02');
INSERT INTO `strategy_award` VALUES (14, 100003, 108, '增加100次使用', '抽奖2次后解锁', 199, 199, 0.0099, 'rule_lock,rule_luck_award', 8, '2023-12-09 09:46:02', '2024-01-13 10:26:29');
INSERT INTO `strategy_award` VALUES (15, 100003, 109, '解锁全部模型', '抽奖6次后解锁', 1, 1, 0.0001, 'rule_lock,rule_luck_award', 9, '2023-12-09 09:46:39', '2023-12-09 12:20:50');
...
INSERT INTO `strategy_rule` VALUES (14, 100001, NULL, 1, 'rule_blacklist', '100:user001,user002,user003', '黑名单抽奖，积分兜底', '2023-12-09 12:59:45', '2024-01-06 14:05:34');
